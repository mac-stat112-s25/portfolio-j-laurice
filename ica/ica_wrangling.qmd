...
b.  get *only* the data on Minnesota - select
...
d.  sort the counties from highest to lowest Democratic support - arrange
...
```{r eval = FALSE}
# What's the first argument? - the elections dataset The second? - the colums we have selected
